...
void bpress(XEvent *e)
{
    ...
    for (MouseShortcut *ms = mshortcuts; ms < mshortcuts + LEN(mshortcuts); ms++) {
...
void propnotify(XEvent *e)
{
    ...
    const XPropertyEvent *xpev = &e->xproperty;
...
{
    const XVisibilityEvent *e = &ev->xvisibility;
...
{
    const XFocusChangeEvent *e = &ev->xfocus;
...
void config_init(void)
{
    ...
    for (ResourcePref *p = resources; p < resources + LEN(resources); p++)
